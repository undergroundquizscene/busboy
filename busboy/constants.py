...
stops_on_220 = [
    ...
    Stop(
        ...
        latitude=DegreeLatitude(51.88033),
        longitude=DegreeLongitude(-8.44087),
        number=241281,
    ),
    Stop(
        id="7338653551721417221",
        name="Douglas East Village (Opp Tramway Tce)",
        latitude=DegreeLatitude(51.87706),
        longitude=DegreeLongitude(-8.43554),
        number=231941,
    ),
    Stop(
        id="7338653551721430251",
        name="Maryborough Hill (Op The Paddocks)",
        latitude=DegreeLatitude(51.87423),
        longitude=DegreeLongitude(-8.42505),
        number=244971,
    ),
    Stop(
        id="7338653551721432261",
        name="Maryborough Hill (Hotel and Spa)",
        latitude=DegreeLatitude(51.87258),
        longitude=DegreeLongitude(-8.42216),
        number=246981,
    ),
    Stop(
        id="7338653551721430601",
        name="Maryborough Hill (Lissadell Southbound)",
        latitude=DegreeLatitude(51.86906),
        longitude=DegreeLongitude(-8.41722),
        number=245321,
    ),
    Stop(
        id="7338653551721430611",
        name="Maryborough Hill (Broadale Southbound)",
        latitude=DegreeLatitude(51.86417),
        longitude=DegreeLongitude(-8.41308),
        number=245331,
    ),
    Stop(
        id="7338653551721431101",
        name="Maryborough Hill (Hilltown Southbound)",
        latitude=DegreeLatitude(51.84916),
        longitude=DegreeLongitude(-8.39799),
        number=245821,
    ),
    Stop(
        id="7338653551721419241",
        name="Carrigaline (Opp Carrignacurra)",
        latitude=DegreeLatitude(51.82798),
        longitude=DegreeLongitude(-8.39605),
        number=233961,
    ),
    Stop(
        id="7338653551721430261",
        name="Carrigaline (Herons Wood)",
        latitude=DegreeLatitude(51.82433),
        longitude=DegreeLongitude(-8.39453),
        number=244981,
    ),
    Stop(
        id="7338653551721430291",
        name="Carrigaline (Opp Glenview)",
        latitude=DegreeLatitude(51.82086),
        longitude=DegreeLongitude(-8.39228),
        number=245011,
    ),
    Stop(
        id="7338653551721430301",
        name="Carrigaline (Cork Rd LyndenDental)",
        latitude=DegreeLatitude(51.81801),
        longitude=DegreeLongitude(-8.39146),
        number=245021,
    ),
    Stop(
        id="7338653551721430311",
        name="Carrigaline (Church)",
        latitude=DegreeLatitude(51.81593),
        longitude=DegreeLongitude(-8.39142),
        number=245031,
    ),
    Stop(
        id="7338653551721416751",
        name="Carrigaline (Town Ctr Bridge Southbound)",
        latitude=DegreeLatitude(51.81345),
        longitude=DegreeLongitude(-8.39233),
        number=231471,
    ),
    Stop(
        id="7338653551721417941",
        name="Carrigaline (Lr Kilmoney Opp Serv Statio",
        latitude=DegreeLatitude(51.81156),
        longitude=DegreeLongitude(-8.39462),
        number=232661,
    ),
    Stop(
        id="7338653551721430321",
        name="Carrigaline (Lr Kilmoney Abbey View)",
        latitude=DegreeLatitude(51.81111),
        longitude=DegreeLongitude(-8.40109),
        number=245041,
    ),
    Stop(
        id="7338653551721430331",
        name="Carrigaline (Lr Kilmoney Clevedon)",
        latitude=DegreeLatitude(51.81073),
        longitude=DegreeLongitude(-8.40376),
        number=245051,
    ),
    Stop(
        id="7338653551721430341",
        name="Carrigaline (Uppr Kilmoney Forest Pk)",
        latitude=DegreeLatitude(51.80642),
        longitude=DegreeLongitude(-8.40409),
        number=245061,
    ),
    Stop(
        id="7338653551721430351",
        name="Carrigaline (Uppr Kilmoney Clevedon)",
        latitude=DegreeLatitude(51.80773),
        longitude=DegreeLongitude(-8.40126),
        number=245071,
    ),
    Stop(
        id="7338653551721418091",
        name="Carrigaline (Liosbourne)",
        latitude=DegreeLatitude(51.80883),
        longitude=DegreeLongitude(-8.39741),
        number=232811,
    ),
    Stop(
        id="7338653551721431151",
        name="Carrigaline (Ferney Road)",
        latitude=DegreeLatitude(51.80877),
        longitude=DegreeLongitude(-8.39143),
        number=245871,
    ),
    Stop(
        id="7338653551721431991",
        name="Carrigaline (Forrest Hills)",
        latitude=DegreeLatitude(51.8084),
        longitude=DegreeLongitude(-8.38483),
        number=246711,
    ),
    Stop(
        id="7338653551721418971",
        name="Kilnagleary Rd (O Learys Cross Southboun",
        latitude=DegreeLatitude(51.80973),
        longitude=DegreeLongitude(-8.35985),
        number=233691,
    ),
    Stop(
        id="7338653551721430361",
        name="Crosshaven (Yacht Club Southbound)",
        latitude=DegreeLatitude(51.80348),
        longitude=DegreeLongitude(-8.3072),
        number=245081,
    ),
    Stop(
        id="7338653551721430371",
        name="Crosshaven (Opp The Grand Apts)",
        latitude=DegreeLatitude(51.80429),
        longitude=DegreeLongitude(-8.30224),
        number=245091,
    ),
    Stop(
        id="7338653551721430381",
        name="Crosshaven (Opp Buckleys Pub)",
        latitude=DegreeLatitude(51.8038),
        longitude=DegreeLongitude(-8.29691),
        number=245101,
    ),
    Stop(
        id="7338653551721417121",
        name="Crosshaven (Village Ctr Southbound)",
        latitude=DegreeLatitude(51.80266),
        longitude=DegreeLongitude(-8.2961),
        number=231841,
    ),
    Stop(
        id="7338653551721431191",
        name="Camden Road (Upper)",
        latitude=DegreeLatitude(51.80707),
        longitude=DegreeLongitude(-8.28837),
        number=245911,
    ),
    Stop(
        id="7338653551721417391",
        name="Fort Camden",
        latitude=DegreeLatitude(51.8096),
        longitude=DegreeLongitude(-8.28123),
        number=232111,
    ),
]
